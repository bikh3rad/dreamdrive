  ...
  return (
    <>
      <PageHead
        ...
        subtitle="نام، رنگ‌ها، نشانی ورود رایگان و قواعد پاداش. قیمت بلیط اینجا نیست؛ در سطوح جایزهٔ هر مسابقه تعیین می‌شود. تغییرات بلافاصله روی سایت عمومی اعمال می‌شود."
        action={
