...
export default function WinnersPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      ...
      {/* بدون این توضیح، کاربری که جایزهٔ دیگری از همان دوره را انتخاب کرده
          بود فکر می‌کند نتیجه‌اش اعلام نشده است. */}
      <p className="mt-2 max-w-xl text-sm text-ink-muted">
        هر دوره یک برنده دارد و جایزه‌ای که می‌بینید همان است که برنده هنگام
        شرکت انتخاب کرده بود؛ جوایز دیگرِ آن دوره برنده‌ای ندارند.
      </p>
