  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-3 max-w-xl text-ink-muted">
        هر مسابقه می‌تواند چند جایزه داشته باشد و تو انتخاب می‌کنی اگر برنده
        شدی کدام را تحویل بگیری. در هر دوره فقط یک برنده هست، پس فقط همان یک
        جایزه اهدا می‌شود. تا پیش از پرشدن ظرفیت یا رسیدن زمان پایان — هر کدام
        زودتر — می‌توانی نقطه‌هایت را ثبت کنی.
      </p>
